...
function shoutbox_add_actions(&$actions)
{
	$actions['shoutbox'] = array('Shoutbox.php', 'Shoutbox');
}
...
function shoutbox_load_permissions(&$permissionGroups, &$permissionList, &$leftPermissionGroups, &$hiddenPermissions, &$relabelPermissions)
{
	...
	$permissionGroups['membergroup']['simple'][] = 'shoutbox';
	$permissionGroups['membergroup']['simple'][] = 'shoutbox_panel';
	$permissionGroups['membergroup']['classic'][] = 'shoutbox';
	$permissionGroups['membergroup']['classic'][] = 'shoutbox_panel';
	...
	$permissionList['membergroup']['shoutbox_edit'] = array(false, 'shoutbox_panel', 'shoutbox_panel');
	$permissionList['membergroup']['shoutbox_delete'] = array(false, 'shoutbox_panel', 'shoutbox_panel');
	$permissionList['membergroup']['shoutbox_prune'] = array(false, 'shoutbox_panel', 'shoutbox_panel');
	$permissionList['membergroup']['shoutbox_ban'] = array(false, 'shoutbox_panel', 'shoutbox_panel');
	
	// Guests only can view!
	$context['non_guest_permissions'] = array_merge($context['non_guest_permissions'], array('shoutbox_post', 'shoutbox_edit', 'shoutbox_delete', 'shoutbox_prune', 'shoutbox_ban'));
}
...
function shoutbox_load_theme()
{
	...
	// Not show in admin
	if (isset($_GET['action']) && $_GET['action'] == 'admin' && isset($_GET['area']) && $_GET['area'] == 'shoutbox')
		return;
	
	// Now do the first insert!
	...
	foreach ($layers as $layer)
    {
        ...
        if ($layer == 'body' || $layer == 'main')
            $context['template_layers'][] = 'shoutbox';
    }
}