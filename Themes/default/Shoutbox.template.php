...
function template_shoutbox_above()
{
	...
	if (isset($shoutbox) && empty($shoutbox['showShoutboxBottom']))
...
function template_shoutbox($main = false)
{
	...
	if ($context['shoutbox']['can_post'] && (!isset($context['shoutbox']['disabled']['color']) || !isset($context['shoutbox']['disabled']['bgcolor'])))
		echo '
	<script language="javascript" type="text/javascript" src="', $settings['default_theme_url'], '/scripts/shoutbox/colorpicker.js"></script>';
	// shoutbox
	echo '
	<script language="javascript" type="text/javascript" src="', $settings['default_theme_url'], '/scripts/shoutbox/shoutbox.js"></script>';
...
<head>
	...
	<script language="JavaScript" type="text/javascript" src="' . $settings['default_theme_url'] . '/scripts/script.js"></script>', $context['html_headers'];
...
<head>
	...
	<script language="JavaScript" type="text/javascript"><!-- // --><![CDATA[
		...
		var smf_charset = "', $context['character_set'], '";
	// ]]></script>
	<script language="JavaScript" type="text/javascript" src="', $settings['default_theme_url'], '/scripts/shoutbox/shoutbox_moderation.js"></script>
	<script language="JavaScript" type="text/javascript"><!-- // --><![CDATA[
